...
I am combining my datasets into one for prediction and making weeks into categorical variables since they aren't increasing linearly.
...
I am filtering the data to only include the last 5 years since the NFL changes at a fast pass. In addition, I tested including more data and it made the predictions worse.
...
I am using the home_team and away_team in my prediction as they can catch information not in variables in my dataset such 
...
I am doing the same thing here but picking the highest rmse within one standard devation of the lowest.
...
Our test set of 2019 data shows that our model isn't that great at predicting attendance, except for attendance between about 65,000 and 75,000. In fact, it seems to be based on luck.

I am also running a boosted tree model.
